...
房间内可以显示邀请二维码，方便手机扫码加入。当前前端使用公开二维码图片服务生成二维码；如果需要完全离线部署，可以改成本地二维码生成库。
...
- `235` 吃豹子。
- 豹子有喜：玩家必须闷过，才触发豹子喜；当局每个其他玩家给出豹子者 `底注 * 20` 的积分。
- 顺金有喜：玩家必须闷过，才触发顺金喜；当局每个其他玩家给出顺金者 `底注 * 10` 的积分。
- 弃牌后牌面不公开。
- 比牌后双方牌面公开。
